...
def topo():
  ...
  router_B = net.addHost( 'rB', cls=LinuxRouter, mac='00:00:00:00:02:00',ip='10.0.0.2/24' )
  ...
  router_C = net.addHost( 'rC', cls=LinuxRouter, mac='00:00:00:00:03:00' ,ip='10.0.0.3/24')
